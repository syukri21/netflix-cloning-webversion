...
class NetflixSlider extends React.Component {
	jqueryEvent = () => {
		var scaling = 1.5;
		//count
	...
	componentDidMount() {
		this.props.popular.results.length !== 0 && this.jqueryEvent();
			...
			<div className='slider-frame'>
				...
				<div className='slider-container'>
					{this.props.popular.results.length !== 0 &&
						this.props.popular.results.map((data, key) => (
...
const NetflixSliderStyles = withStyles(styles)(NetflixSlider);

const NetflixSliderStylesConnect = connect(mapStateToProps)(NetflixSliderStyles);

export default NetflixSliderStylesConnect;
